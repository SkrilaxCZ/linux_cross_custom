...
export PACKAGE_ARGS="--sysconfdir=/etc --localstatedir=/var --libexecdir=/usr/lib/dbus-1.0 --with-console-auth-dir=/run/console --enable-abstract-sockets --disable-static"
